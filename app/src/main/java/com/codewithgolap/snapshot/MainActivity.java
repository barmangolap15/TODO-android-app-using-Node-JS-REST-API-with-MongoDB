...
import com.codewithgolap.snapshot.Fragments.FinishedTaskFragment;
import com.codewithgolap.snapshot.Fragments.HomeFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_email = (TextView) hdView.findViewById(R.id.useremail);
        user_image = (CircleImageView) hdView.findViewById(R.id.avatar);
    ...
    private void getUserProfile() {
        String url = "https://snapshotproject.herokuapp.com/api/snapshot/auth";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getBoolean("success")){
                                ...
                                Picasso.get().load(userObj.getString("avatar"))
                                        .placeholder(R.drawable.icon_profile_main)
                                        .error(R.drawable.icon_profile_main)
                                        .into(user_image);
                            }
